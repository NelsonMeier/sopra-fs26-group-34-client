...
<div data-layer="User Profile" className="UserProfile" style={{width: "min(1100px, 100%)", display: "grid", gridTemplateRows: "auto auto auto", rowGap: "28px", paddingTop: "28px", paddingBottom: "24px", position: 'relative', background: '#77B8D2'}}>
  ...
  <div data-layer="Middle" className="Middle" style={{display: "grid", gridTemplateColumns: "1fr 260px", columnGap: "42px", alignItems: "start"}}>
    <div data-layer="Left Info" className="Left Info" style={{display: "grid", rowGap: "16px"}}>
      ...
      <div data-layer="Friends Row" className="Friends Row" style={{display: "grid", gridTemplateColumns: "190px 250px", columnGap: "12px", alignItems: "center"}}>
        ...
        <div data-layer="FriendsListValue" className="friendsListValue" style={{background: "#DBDBDB", borderRadius: 10, padding: "6px 12px", minHeight: "42px", maxHeight: "140px", display: "flex", alignItems: "center", justifyContent: 'flex-start', alignItems: "flex-start",flexDirection: 'column', color: 'black', fontSize: 24, fontFamily: 'Gluten', fontWeight: '400', wordWrap: 'break-word', overflowY: 'auto'}}></div>
      </div>
    </div>
